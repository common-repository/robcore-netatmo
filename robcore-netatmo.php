...
function rnpfw_shortcodeDatiMeteo( $atts ) {
    ...
    elseif ($a['data'] == "rain-1h") {
    	return $oggettoMeteoPerShortcode->rnpfw_rain1h($a['module_id'],$a['station_id'], $client) . " mm";
    }
    elseif ($a['data'] == "rain-today") {
    	return $oggettoMeteoPerShortcode->rnpfw_rainToday($a['module_id'],$a['station_id'], $client) . " mm";
    }
	else {
