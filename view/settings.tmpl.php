...
<table id="tabella-pag-settings">
	<tr>
		...
		<td class="td-pagina-settings">
		<h2>External/internal modules found:</h2>
...
<!-- ################################# PLUVIO ################################# -->
			...
			<h2>Pluviometers found:</h2>
			<ul class="elenco-pluvio">
			<?php foreach ($oggettoMeteo->rnpfw_ottieniIDElementi("pluvio", $client) as $accoppiata_modulo_staz) {
				echo "<li>";
				echo "ID: <span style='color: #0073aa'>$accoppiata_modulo_staz[0]</span> - Name: <span style='color: #0073aa'>$accoppiata_modulo_staz[1]</span> - Associated station: <span style='color: #0073aa'>$accoppiata_modulo_staz[2]</span>";
				echo "<br>";
				echo "Rain 1h: ";

				echo "<span style='color: #0073aa'>" . $oggettoMeteo->rnpfw_rain1h($accoppiata_modulo_staz[0], $accoppiata_modulo_staz[2], $client) . " mm</span>";

				echo " - ";
				echo "Rain today: ";
				echo "<span style='color: #0073aa'>" . $oggettoMeteo->rnpfw_rainToday($accoppiata_modulo_staz[0], $accoppiata_modulo_staz[2], $client) . " mm</span>";
				
				echo "<h4>Shortcodes available for this module:</h4>";
				echo "<pre>";
				echo "Rain 1h:<br>";
				echo "<strong>[robcore-netatmo data = rain-1h module_id ='$accoppiata_modulo_staz[0]' station_id = '$accoppiata_modulo_staz[2]']</strong><br>";
				
				echo "<br>";
				
				echo "Rain Today:<br>";
				echo "<strong>[robcore-netatmo data = rain-today module_id ='$accoppiata_modulo_staz[0]' station_id = '$accoppiata_modulo_staz[2]']</strong><br>";
				echo "</pre>";
